...
// Source: github.com/TemurMannonov/query_analyzer/storage (interfaces: DBRepositoryI)
...
import (
	...
	models "github.com/TemurMannonov/query_analyzer/models"
...
func (m *MockDBRepositoryI) GetList(arg0 *models.GetQueriesRequest) (*models.GetQueriesResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetList", arg0)
	ret0, _ := ret[0].(*models.GetQueriesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
